            ...
            <div class="grid md:grid-cols-2 gap-6">
                @foreach ($products as $product)
                    ...
                    <a href="{{ $productUrl }}" class="group block h-full">
                        <article class="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden flex flex-col h-full transition transform group-hover:-translate-y-1 group-hover:shadow-md">
                            ...
                            <div class="p-6 flex-1 flex flex-col space-y-4">
                                <div class="space-y-1">
                                    ...
                                    <h2 class="text-2xl font-semibold group-hover:text-indigo-600">{{ $product->name }}</h2>
